...
> fabric-contract-api@2.4.2 lint
> eslint ./lib/


> fabric-contract-api@2.4.2 test:unit
> npm run test


> fabric-contract-api@2.4.2 test
> nyc mocha --recursive 'test/unit/**/*.js'
  ...
  Default.js
    Default
2022-05-04T11:15:59.390Z info [c-api:./lib/annotations/default.js]                @Default args: "Target ->","mockTarget" 
      ✔ should add set value for default when none set
2022-05-04T11:15:59.396Z info [c-api:./lib/annotations/default.js]                @Default args: "Target ->","mockTarget" 
      ✔ should error when default already set

  Info.js
    Info
2022-05-04T11:15:59.398Z info [c-api:./lib/annotations/info.js]                   @Info args: "Info -> [object Object],","Target ->","steve" 
      ✔ should add object as key when no objects exist for global yet
2022-05-04T11:15:59.400Z info [c-api:./lib/annotations/info.js]                   @Info args: "Info -> [object Object],","Target ->","steve" 
      ✔ should add object as key when objects exist for global
    Info with data
2022-05-04T11:15:59.401Z info [c-api:./lib/annotations/info.js]                   @Info args: "Info -> [object Object],","Target ->","steve" 
      ✔ should add object as key when no objects exist for global yet
2022-05-04T11:15:59.403Z info [c-api:./lib/annotations/info.js]                   @Info args: "Info -> [object Object],","Target ->","steve" 
      ✔ should add object as key when objects exist for global

  Object.js
    #Object
2022-05-04T11:15:59.405Z info [c-api:./lib/annotations/object.js]                 @Object args: Target -> %s "Function" 
      ✔ should add object as key when no objects exist for global yet
2022-05-04T11:15:59.407Z info [c-api:./lib/annotations/object.js]                 @Object args: Target -> %s "Function" 
      ✔ should add object as key when objects exist for global
2022-05-04T11:15:59.409Z info [c-api:./lib/annotations/object.js]                 @Object args: Target -> %s "Function" 
      ✔ should add object with no supertype
2022-05-04T11:15:59.410Z info [c-api:./lib/annotations/object.js]                 @Object args: Target -> %s "Function" 
  ...
  Transaction.js
    Transaction
2022-05-04T11:15:59.418Z info [c-api:./lib/annotations/transaction.js]            @Transaction args: "Property Key -> mockKey, Commit -> true,","Target ->","Object" 
      ✔ should handle existing transactions
2022-05-04T11:15:59.422Z info [c-api:./lib/annotations/transaction.js]            @Transaction args: "Property Key -> mockKey, Commit -> true,","Target ->","Object" 
      ✔ should error if missing type
2022-05-04T11:15:59.424Z info [c-api:./lib/annotations/transaction.js]            @Transaction args: "Property Key -> mockKey, Commit -> true,","Target ->","Object" 
      ✔ should handle existing transactions of which matches name and already has param metadata
2022-05-04T11:15:59.426Z info [c-api:./lib/annotations/transaction.js]            @Transaction args: "Property Key -> mockKey, Commit -> true,","Target ->","Object" 
      ✔ should create new metadata for fabric:transactions if none exist and handle no params
2022-05-04T11:15:59.428Z info [c-api:./lib/annotations/transaction.js]            @Transaction args: "Property Key -> mockKey, Commit -> false,","Target ->","Object" 
      ✔ should not add a tag if commit is false
    Returns
2022-05-04T11:15:59.430Z info [c-api:./lib/annotations/transaction.js]            @Returns args: ", Property Key -> mockKey, Return Type -> someType,","Target ->","Object" 
      ✔ should handle existing transactions
2022-05-04T11:15:59.432Z info [c-api:./lib/annotations/transaction.js]            @Returns args: ", Property Key -> mockKey, Return Type -> someType,","Target ->","Object" 
      ✔ should handle when there are no existing transactions
    Param
2022-05-04T11:15:59.434Z info [c-api:./lib/annotations/transaction.js]            @Param args: "Property Key -> mockKey, Param Name -> some param, Param Type -> some type, Description -> some description,","Target ->","Object" 
      ✔ should overwrite when the transaction exists and param of name already in
2022-05-04T11:15:59.437Z info [c-api:./lib/annotations/transaction.js]            @Param args: "Property Key -> mockKey, Param Name -> some param, Param Type -> some type, Description -> some description,","Target ->","Object" 
      ✔ should overwrite existing transaction but add new param when one with name does not exist
2022-05-04T11:15:59.439Z info [c-api:./lib/annotations/transaction.js]            @Param args: "Property Key -> mockKey, Param Name -> some param, Param Type -> some type, Description -> some description,","Target ->","Object" 
      ✔ should append to transaction a new parameters array when transaction exists but has not parameters field
2022-05-04T11:15:59.441Z info [c-api:./lib/annotations/transaction.js]            @Param args: "Property Key -> mockKey, Param Name -> some param, Param Type -> some type, Description -> some description,","Target ->","Object" 
      ✔ should handle when no transaction exists
2022-05-04T11:15:59.444Z info [c-api:./lib/annotations/transaction.js]            @Param args: "Property Key -> mockKey, Param Name -> some param, Param Type -> some type, Description -> undefined,","Target ->","Object" 
...
2022-05-04T11:15:59.453Z error [c-api:./lib/contract.js]                          [some id] Contract contract-api.Contract unknown transaction "wibble", 
...
2022-05-04T11:15:59.463Z error [c-api:./lib/jsontransactionserializer.js]         undefined toBuffer validation against schema failed on type "number","string" 
...
2022-05-04T11:15:59.471Z error [c-api:./lib/jsontransactionserializer.js]         undefined fromBuffer no data supplied  
      ✔ should throw an error if nothing given
      ✔ should throw an error if not a number
      ✔ should throw an error if bad boolean given
2022-05-04T11:15:59.472Z error [c-api:./lib/jsontransactionserializer.js]         fromBuffer could not parse data as JSON to allow it to be converted to type: "some type" "trie",{} 
2022-05-04T11:15:59.472Z error [c-api:./lib/jsontransactionserializer.js]         Converting data to string and JSON.stringify-ing  
  ...
  Logger
    ✔ coverage
2022-05-04T11:15:59.481Z error [c-api:_]                                          Unhandled Rejection reason __PERMITTED__ promise Promise { <rejected> '__PERMITTED__' }  
2022-05-04T11:15:59.482Z error [c-api:_]                                          Unhandled Rejection reason __PERMITTED__ promise Promise { <rejected> '__PERMITTED__' }  
    getLogger
...
> fabric-contract-api@2.4.2 test:schema
