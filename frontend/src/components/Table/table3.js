...
function Table3({ tableName, tableData, columnNames, patientIdButtonClick }) {
                                        ...
                                        <table className="min-w-full divide-y divide-gray-200">
                                            ...
                                            <tbody className="bg-white divide-y divide-gray-200">
                                                {tableData.map((item, index) => {
                                                    ...
                                                    console.log("item: ", item["patientId"]);
                                                    let id = item["patientId"];
                                                    return (
                                                        <tr className="button-cursor" key={index} onClick={() => patientIdButtonClick(item["patientId"])} >
                                                            {
                                                                keys.map((key, i) => {
                                                                    console.log("key: ", key);
