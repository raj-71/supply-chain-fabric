...
installChannels() {
  ...
  docker exec -i cli.seller.supplychain.com bash -c "source scripts/channel_fns.sh; fetchChannelAndJoin 'my-channel1' 'sellerMSP' 'peer0.seller.supplychain.com:7061' 'crypto/users/Admin@seller.supplychain.com/msp' 'orderer0.group1.orderer.supplychain.com:7030';"
  printItalics "Joining 'my-channel1' on  consumer/peer0" "U1F638"
  docker exec -i cli.consumer.supplychain.com bash -c "source scripts/channel_fns.sh; fetchChannelAndJoin 'my-channel1' 'consumerMSP' 'peer0.consumer.supplychain.com:7081' 'crypto/users/Admin@consumer.supplychain.com/msp' 'orderer0.group1.orderer.supplychain.com:7030';"
}
...
installChaincodes() {
  if [ -n "$(ls "$CHAINCODES_BASE_DIR/./chaincodes/chaincode-kv-node")" ]; then
    ...
    chaincodeInstall "cli.seller.supplychain.com" "peer0.seller.supplychain.com:7061" "chaincode1" "$version" ""
    chaincodeApprove "cli.seller.supplychain.com" "peer0.seller.supplychain.com:7061" "my-channel1" "chaincode1" "$version" "orderer0.group1.orderer.supplychain.com:7030" "" "false" "" ""
    printHeadline "Installing 'chaincode1' for consumer" "U1F60E"
    chaincodeInstall "cli.consumer.supplychain.com" "peer0.consumer.supplychain.com:7081" "chaincode1" "$version" ""
    chaincodeApprove "cli.consumer.supplychain.com" "peer0.consumer.supplychain.com:7081" "my-channel1" "chaincode1" "$version" "orderer0.group1.orderer.supplychain.com:7030" "" "false" "" ""
    printItalics "Committing chaincode 'chaincode1' on channel 'my-channel1' as 'farmer'" "U1F618"
    chaincodeCommit "cli.farmer.supplychain.com" "peer0.farmer.supplychain.com:7041" "my-channel1" "chaincode1" "$version" "orderer0.group1.orderer.supplychain.com:7030" "" "false" "" "peer0.farmer.supplychain.com:7041,peer0.seller.supplychain.com:7061,peer0.consumer.supplychain.com:7081" "" ""
  else
...
notifyOrgsAboutChannels() {
  ...
  notifyOrgAboutNewChannel "my-channel1" "sellerMSP" "cli.seller.supplychain.com" "peer0.seller.supplychain.com" "orderer0.group1.orderer.supplychain.com:7030"
  notifyOrgAboutNewChannel "my-channel1" "consumerMSP" "cli.consumer.supplychain.com" "peer0.consumer.supplychain.com" "orderer0.group1.orderer.supplychain.com:7030"
